...
var modal = function modal(source) {
  ...
  if (existingModal !== null) {
    ...
    var style = 'margin: auto; width: 100%; border: none; height: 100%;';
    var iframe = '<iframe id="creditkey-iframe" src="' + (source + '?modal=true') + '" style="' + style + '" height="100%" width="100%"></iframe>';
